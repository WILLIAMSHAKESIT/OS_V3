...
export default class Controller {
    ...
    private createInfoButton(){
        this.info_button = Functions.loadSprite(this.app.loader, 'my_slot_controllers', 'info_button.png', false);
    ...
    private createMenuButton(){
        this.menu_button = Functions.loadSprite(this.app.loader, 'my_slot_controllers', 'menu_button.png', false);
