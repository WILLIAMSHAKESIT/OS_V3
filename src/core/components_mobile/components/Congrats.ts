...
export default class NiceOne {
    ...
    private hide() {
        ...
        const coinsContainer = gsap.to(this.coinsContainer, {
          ...
          onComplete: () => {
            ...
            this.container.removeChild(this.displaySpin);
    ...
    private createWinLogo() {
        this.logo = Functions.loadSprite(this.app.loader, 'won_spin', '', true);
    ...
    private createDisplayMoney() {
        ...
        this.displaySpin = new PIXI.Text(`IN ${this.spin} FREE SPIN`, style2);
        this.displaySpin.y = ((this.app.screen.height - this.displaySpin.height) / 2) + 20;
        this.displaySpin.x = (this.app.screen.width - this.displaySpin.width) / 2;
        this.displaySpin.y += 205;

        this.container.addChild(this.displaySpin);
